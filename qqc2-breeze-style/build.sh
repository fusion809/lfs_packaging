...
blfs_depends=(breeze-icons karchive kcolorscheme kconfig kguiaddons ki18n kiconthemes kirigami libXau libXdmcp libdrm libxcb llvm lm-sensors qt6 spirv-tools)
