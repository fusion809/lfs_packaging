...
blfs_depends=(breeze-icons frameworkintegration karchive kcmutils kcodecs kcolorscheme kcompletion kconfig kconfigwidgets kcoreaddons kglobalaccel kguiaddons ki18n kiconthemes kitemviews kwidgetsaddons kwindowsystem kxmlgui libXau libXdmcp libdrm libxcb llvm lm-sensors qt6 spirv-tools xcb-util-keysyms)
