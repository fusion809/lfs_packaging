...
get_version() {
  ...
  local up_ver=$(wget --timeout=2 -cqO- https://www.openldap.org/software/download/OpenLDAP/openldap-release/ | grep "openldap-[0-9.]*.tgz\"" | cut -d '"' -f 2 | cut -d '-' -f 2 | sed 's/.tgz//g' | tail -n 1)
